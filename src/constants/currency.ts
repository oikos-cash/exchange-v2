...
export const currencyKeyToIconMap = {
	...
	[SYNTHS_MAP.oBNB]: { SynthIcon: sBNBIcon, AssetIcon: BNBIcon },
	...
	[SYNTHS_MAP.oXAU]: { SynthIcon: sXAUIcon, AssetIcon: GOLDIcon },
...
export const BASE_TRADING_PAIRS = [SYNTHS_MAP.oUSD, SYNTHS_MAP.oBTC, SYNTHS_MAP.oUSD_EXCHANGE_RATE];
